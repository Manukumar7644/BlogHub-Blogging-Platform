...
public class AuthorController {
    ...
    public ResponseEntity<?> updateUser(
        ...
        AuthorResponseDTO responseDTO = new AuthorResponseDTO(updatedAuthor.getId(),updatedAuthor.getName(), updatedAuthor.getEmail(), updatedAuthor.getRole(), updatedAuthor.getAbout());
	...
	public ResponseEntity<List<AuthorResponseDTO>> getAllUsers(){
    	List<Author> authorList =  authorServ.getAllUsers();
    	
    	List<AuthorResponseDTO> respList = new ArrayList<>();
    	for(Author author : authorList) {
    		AuthorResponseDTO responseDTO = new AuthorResponseDTO(author.getId(),author.getName(), author.getEmail(), author.getRole(), author.getAbout());
